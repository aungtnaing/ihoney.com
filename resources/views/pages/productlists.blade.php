						...
						<div class="row">
							<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
								<div class="product-view-mode">
									<a href="{{ url('/productgrids',[$type, $typeid]) }}"><i class="fa fa-th-large"></i></a>
									<a href="{{ url('/productlists',[$type, $typeid]) }}"  class="active"><i class="fa fa-th-list"></i></a>
								</div>
							</div>
							...
							<div class="col-xs-12 col-sm-8 col-md-8">
								<div class="product-caption">
									...
									<div class="product-rating">
			                            ...
			                            @else
			                            <p class="description">{{ substr($product->description,0, 500) }}..</p>
			                            @endif
