                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <ul class="footer-payments pull-right">
                                <li><img src="<?php echo url(); ?>/img/payment-maestro.jpg" alt="payment" /></li>
                                <li><img src="<?php echo url(); ?>/img/payment-discover.jpg" alt="payment" /></li>
                                <li><img src="<?php echo url(); ?>/img/payment-visa.jpg" alt="payment" /></li>
                                <li><img src="<?php echo url(); ?>/img/payment-american-express.jpg" alt="payment" /></li>
                                <li><img src="<?php echo url(); ?>/img/payment-paypal.jpg" alt="payment" /></li>
                            </ul>
                        </div>
                    </div>
                </div>
