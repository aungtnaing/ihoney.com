                                        ...
                                        <div id="container-fixed">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="top-icons">
                                                        <div class="top-icon"><a href="{{ url('wishlist') }}" title="Wishlist"><i class="fa fa-heart"></i></a></div>
                                                ...
                                                <ul class="nav navbar-nav">
                                                    ...
                                                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Home <i class="fa fa-caret-right fa-rotate-45"></i></a>
                                                        <ul class="dropdown-menu list-unstyled fadeInUp animated">
                                                            ...
                                                            <li>
                                                                <a  href="{{ url('headerlight') }}"> Home Header Light</a>
                                                            </li>
                                                           <!--  <li>
                                                    ...
                                                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Base Pages <i class="fa fa-caret-right fa-rotate-45"></i></a>
                                                        <ul class="dropdown-menu list-unstyled fadeInUp animated">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                            ...
                                                                            <ul class="list-unstyled">
                                                                                <li>
                                                                                    <a  href="{{ url('blogitems') }}"> Blog items </a>
                                                                                </li>
                                                                                <li>
                                                                                    <a  href="{{ url('postitems') }}"> Post items </a>
                                                                                </li>
                                                                                <li>
                                                        ...
                                                        <li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Product Pages <i class="fa fa-caret-right fa-rotate-45"></i></a>
                                                            <ul class="dropdown-menu list-unstyled fadeInUp animated">
                                                                ...
                                                                <div class="yamm-content">
                                                                    <div class="row">
                                                                        <div class="col-md-4">
                                                                            ...
                                                                            <ul class="list-unstyled">
                                                                                <li>
                                                                                    <a href="{{ url('/productgrids',['maincategory', 1]) }}"><i class="fa fa-angle-right"></i> Product grid </a>
                                                                                </li>
                                                                                <li>
                                                                                    <a href="{{ url('/productlists',['maincategory', 2]) }}"><i class="fa fa-angle-right"></i> Product list </a>
                                                                                </li>
                                                                                <li>
                                                    ...
                                                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Cart Pages <i class="fa fa-caret-right fa-rotate-45"></i></a>
                                                        <ul class="dropdown-menu list-unstyled fadeInUp animated">
                                                            ...
                                                            <div class="yamm-content">
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        ...
                                                                        <li>
                                                                            <a  href=""><i class="fa fa-tasks"></i> Order History </a>
                                                                        </li>
                                                                        <li>
                                                                            <a  href=""><i class="fa fa-random"></i> Compare </a>
                                                                        </li>
                                                                        <li>
                                                                    ...
                                                                    <div class="yamm-content">
                                                                        <div class="row">
                                                                            <div class="col-md-3">
                                                                                ...
                                                                                <ul class="list-unstyled">
                                                                                    @foreach ($maincategorys[1]->categorys as $category)
                                                                            ...
                                                                            <div class="col-md-3">
                                                                                ...
                                                                                <ul class="list-unstyled">
                                                                                     @foreach ($maincategorys[0]->categorys as $category)
                                                                                        <li><a href="{{ url('/productlists',['category', $category->id]) }}"><i class="fa fa-check"></i>{{ $category->name }}</a></li>
                                                                                    @endforeach
