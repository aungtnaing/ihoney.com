			...
			<div class="panel-body">
				...
				<form action="{{ route("posts.update", $post->id) }}" method="POST" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<label for="file-input1"><i class="lnr lnr-camera"></i>...post 800 x 450<br>
							@if($post->photourl1!="")
					...
					<div class="row">
						<div class="form-group">
							...
							<input type="text" width: 200px; class="form-control" id="" name="name" placeholder="Enter name" value="{{ $post->name }}">
						</div>
					...
					<div class="form-group">
						...
						<textarea name="content" placeholder="Enter your content" class="form-control" rows="5">{{ $post->content }}</textarea>
					</div>
